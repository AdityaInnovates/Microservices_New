...
import FloatingButton from "../components/maincomponents/floatingButton.jsx";
          ...
          >
            ...
            <div className="w-[100%] flex justify-center gap-[4rem] mt-1">
              <a
                ...
                className="bg-cyan-400 cursor-pointer rounded-md py-2 px-8 mt-5 text-white hover:bg-cyan-600 hover:rounded-3xl transition-all duration-300"
              >
                Search
              </a>
              <Link href={"dataRepresent"}>
                <a className="bg-cyan-400 rounded-md py-2 px-8 mt-5 text-white hover:bg-cyan-600 hover:rounded-3xl transition-all duration-300">
