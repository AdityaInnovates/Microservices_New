  ...
  const arr = [
    {
      img: "impSvg/pen.svg",
      header: "Completion",
      content: "Generate or manipulate text and code",
      color: "#19c37d",
    },
    {
      img: "impSvg/3dmodel.svg",
      header: "Fine-tuning",
      content: "Train a model for your use case",
      color: "#ef4146",
    },
    {
      img: "impSvg/questionmark.svg",
      header: "Question Answering",
      content: "Generate high-accuracy answers",
      color: "#f4ac36",
    },
    {
      img: "impSvg/pageSearch.svg",
      header: "Semantic search",
      content: "Score text based on relevance",
      color: "#5436da",
    },
    {
      img: "impSvg/tag.svg",
      header: "Classification",
      content: "Classify text into different categories",
      color: "#dd5ce5",
    },
  ];
  return (
      ...
      <div className="outercont max-w-full w-[93%] m-auto mt-[1.6rem] md:w-[50%] ">
        <div className="innerofoutercont">
          <div className="headerofcont">
            <h3 className="font-bold text-[2rem]">Explore the OpenAI API</h3>
          </div>
          <div>
          ...
          <div>
            <div className="flex flex-row space-x-6">
              <Link
                ...
                // }}
              >
                <a className=" relative  cursor-pointer hover:opacity-[0.87] transition-all duration-[0.4s]">
                  <img
                  ...
                  <div className=" absolute bottom-[0.6rem] left-[1.1rem] text-white text">
                    <h3 className="font-medium">Quickstart tutorial</h3>
              ...
              >
                ...
                <div className=" absolute bottom-[0.6rem] left-[1.1rem] text-white">
                  ...
                  <p>Explore some example tasks</p>
                </div>
              </div>
            </div>
          </div>
